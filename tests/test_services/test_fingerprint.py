...
def test_different_start_time_produces_different_fingerprint():
    base = dict(
        seller_id=1, venue="Arena", listing_date=date(2024, 6, 1), end_time=time(11, 0)
    )
...
def test_different_end_time_produces_different_fingerprint():
    base = dict(
        seller_id=1, venue="Arena", listing_date=date(2024, 6, 1), start_time=time(9, 0)
    )
...
def test_all_none_fields_produces_consistent_fingerprint():
    fp1 = make_fingerprint(
        seller_id=None, venue=None, listing_date=None, start_time=None, end_time=None
    )
